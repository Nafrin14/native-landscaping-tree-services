  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white via-white to-green-50 py-20 lg:py-28">
      ...
      <div className="pointer-events-none absolute -left-10 top-24 hidden text-green-100 lg:block">
        <FaLeaf size={150} className="-rotate-45" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <span className="inline-flex items-center gap-3 rounded-full bg-green-100 px-6 py-3 text-sm font-extrabold uppercase tracking-[0.24em] text-[#078c45]">
            <FaLeaf />
            Testimonials
          </span>
          ...
          <h2 className="mt-6 text-4xl font-extrabold leading-tight text-[#10351f] sm:text-5xl lg:text-5xl">
            What Our{" "}
            <span className="text-[#078c45]">Customers</span> Say
          </h2>

          <div className="mx-auto mt-5 flex items-center justify-center gap-4">
            <span className="h-px w-20 bg-green-200" />

            <FaLeaf className="text-[#078c45]" />
        ...
        <div className="mt-12 grid gap-7 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((testimonial) => (
            <article
              ...
              className="group flex h-full flex-col rounded-[2rem] border border-gray-200 bg-white p-7 shadow-lg transition-all duration-300 hover:-translate-y-3 hover:border-green-200 hover:shadow-2xl sm:p-8"
            >
              <FaQuoteLeft
                size={38}
                className="text-[#086534] transition-transform duration-300 group-hover:scale-110"
              />

              <div className="mt-6 flex gap-1 text-yellow-400">
                {Array.from({ length: 5 }).map((_, index) => (
                  <FaStar key={index} size={21} />
                ))}
              </div>
              ...
              <div className="mt-8 border-t border-gray-200 pt-6">
                <div className="flex items-center gap-4">
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#078c45] to-[#064e2c] text-white shadow-lg">
                    <FaUser size={23} />
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 flex items-center gap-2 text-sm text-gray-500">
                      <FaMapMarkerAlt className="text-[#078c45]" />
